...
function installnewtheme_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function installnewtheme_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function installnewtheme_feed_icon($url) {
 ...
 */
function installnewtheme_comment_wrapper($content, $type = null) {
  static $node_type;
