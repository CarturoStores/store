...
function installnewtheme_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function installnewtheme_button($variables) {
 ...
 */
function installnewtheme_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function installnewtheme_menu_local_task($variables) {
 ...
 */
function installnewtheme_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function installnewtheme_node_preview($variables) {
  $node = $variables['node'];
