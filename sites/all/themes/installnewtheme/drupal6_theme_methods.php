...
function installnewtheme_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function installnewtheme_feed_icon($url, $title) {
 ...
 */
function installnewtheme_preprocess_comment_wrapper(&$vars) {
 ...
 */
function installnewtheme_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function installnewtheme_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function installnewtheme_button($element) {
...
*/
function installnewtheme_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function installnewtheme_node_preview($node) {
